...
//     // Build payload dynamically based on editable fields
//     const payload = {
//       name: editName,
//       email: editEmail,
//       phone: editPhone,
...
//     const response = await fetch(`${BASE_URL}/public/agents/${selectedEmployee._id}`, {
//       method: "PUT",
//       headers: {
...
//     try {
//       const res = await fetch(`${BASE_URL}/public/agents/${selectedEmployee._id}`, {
//         method: "DELETE",
//         headers: {
//           "Content-Type": "application/json",
...
//     const token = typeof window !== "undefined" ? localStorage.getItem("adminToken") : null
//     try {
//       const res = await fetch(`${BASE_URL}/public/agents/${emp._id}/block`, {
//         method: "PUT",
//         headers: {
//           "Content-Type": "application/json",
//           ...(token ? { Authorization: `Bearer ${token}` } : {}),
...
//       const data = await res.json()
//       if (!res.ok) {
//         alert(data?.message || "Failed to toggle block")
//         return
//       }

//       const isBlocked = data?.agent?.isBlocked ?? data?.isBlocked ?? false
//       setEmployees((prev) =>
//         prev.map((e) => (e._id === emp._id ? { ...e, status: isBlocked ? "Inactive" : "Active" } : e)),
//       )
//     } catch (error) {
...
//   // Fetch agents from backend (use the mounted path /api/public/agents)
...
//       // If server returns non-JSON or empty body, handle gracefully
//       const body = await res.json().catch(() => null)
                      ...
                      <div className="flex items-center justify-between lg:justify-end space-x-4 lg:space-x-6">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => {
                                // navigate to the clients page and pass the agentId as a query param
